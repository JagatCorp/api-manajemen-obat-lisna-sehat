...
// Serialize
// const adminSerializer = new JSONAPISerializer("satuan", {
...
exports.findAll = async (req, res) => {
  try {
    ...
    // const admin = adminSerializer.serialize(satuan);
    // const admin = satuan;
...
exports.findOne = async (req, res) => {
  ...
  try {
    ...
    const serializedSatuan = adminSerializer.serialize(satuan);
...
exports.update = async (req, res) => {
  ...
  if (req.body.password) {
    ...
    // Update satuan object with hashed password
